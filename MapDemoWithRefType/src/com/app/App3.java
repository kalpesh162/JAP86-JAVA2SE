...
public class App3 {
	...
	static void displayAllBooks(TreeMap<Integer, Book> miniLib) {
	...
	static void displayAllBooks(Map<Integer, Book> miniLib) {
...
// Integer class type Comparable   --> compareTo
		TreeMap<Integer, Book> miniLib = new TreeMap<Integer, Book>();
		...
		Map<Integer, Book> map = miniLib.descendingMap();
